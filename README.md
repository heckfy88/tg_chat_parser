...
MAX_FILE_SIZE=<int: максимальный размер принимаемого файла (боты telegram не принимают файлы более 50 МБ), но вы можете указать размер меньше>
MAX_FILES_AMOUNT=<int: максимальное количество принимаемых за раз файлов>
EXCEL_USER_THRESHOLD=<int: порог пользователей для вывода в excel файл, необязательное поле, базово до 200 выведет в чат>
```
